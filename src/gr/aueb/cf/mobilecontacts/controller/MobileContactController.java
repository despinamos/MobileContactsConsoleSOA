...
public class MobileContactController {
    ...
    public String insertContact(MobileContactInsertDTO insertDTO) {
        ...
        try {
            ...
            return "OK\n Contact inserted." + Serializer.serializeDTO(readOnlyDTO);
        } catch(PhoneNumberAlreadyExistsException e) {
            return "Error.\n Phone Number already exists." + e.getMessage() + "\n";
        }
    }
    ...
    public String updateContact(MobileContactUpdateDTO updateDTO) {
        ...
        try {
            ...
            return "Error.\n during update. Phone number already exists." + e.getMessage() + "\n";
        } catch (ContactNotFoundException e){
            return "Error.\n during update. Contact not found." + e.getMessage() + "\n";
        }
    }
    ...
    public String deleteContactById (Long id) {
        try {
            ...
            return "Error.\n during delete. Contact not found.";
        }
    }
